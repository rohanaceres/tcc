...
\input{chapters/chapter1-historical-summary}

% ----------------------------------------------------------
% Capítulo 2: Proposição do problema
% ----------------------------------------------------------
\chapter{Proposição do problema}
\input{chapters/chapter2-problem-proposition}

% ----------------------------------------------------------
% Capítulo 3: Solução proposta
% ----------------------------------------------------------
\chapter{Solução proposta}
\input{chapters/chapter3-solution-proposition}
